    ...
    return (
        <div>
            ...
            <TitleForm 
                ...
                <InputFile 
                    width="300px" 
                    id="idTandaTanganAyah" 
                    label="Tanda Tangan Ayah" 
                    name="tandaTanganAyahMempelai" 
                    image={props.data.ayah.tandaTangan}
                    onChangeInput={onChangeInput} 
                    defaultValue={props.data.ayah.tandaTangan}
                />
                <InputFile 
                    width="300px" 
                    id="idTandaTanganIbu" 
                    label="Tanda Tangan Ibu" 
                    name="tandaTanganIbuMempelai" 
                    image={props.data.ibu.tandaTangan}
                    onChangeInput={onChangeInput} 
                    defaultValue={props.data.ibu.tandaTangan}
                />
            </div>
        </div>
    );
